            ...
            <form>
              ...
              <div className="sm:flex justify-between mb-6">
                <div className="flex items-start h-5">
                  <input id="remember" checked={keepLogin} onChange={(e) => checkBoxValue(e)} type="checkbox" value="" className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800" required />
                  <label htmlFor="remember" className="ms-2 text-sm font-medium text-gray-400 dark:text-gray-300">Keep me logged in</label>
                </div>
              ...
              <div className="w-full">
                <button type="submit" className={`shadow-lg w-full  text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600  cursor-pointer  font-medium rounded-md text-lg   px-5 py-2.5 text-center `}>Sign In</button>
              </div>
