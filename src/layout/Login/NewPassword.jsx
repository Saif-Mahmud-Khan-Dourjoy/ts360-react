              ...
              <div className="mt-14">
                <form>
                  ...
                  <div className="w-full">
                    <Link ><button onClick={(e) => setReset(true)} type="submit" className={`shadow-lg w-full  text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600  cursor-pointer  font-medium rounded-md text-lg   px-5 py-2.5 text-center `}>Reset Password</button></Link>
                  </div>
