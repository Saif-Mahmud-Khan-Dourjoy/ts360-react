...
export default function AboutUs() {
  return (
    <>
      <div className="lg:px-24 px-7 pt-44">
        <div className="font-bold text-3xl md:text-5xl text-center">
        ...
        <div className="mt-12 md:mt-16 text-center w-full md:w-[90%] xl:w-[60%] mx-auto text-lg text-gray-400">
        ...
        <div className="mt-10 mb-16">
          <div className="flex sm:justify-between sm:items-center px-5 py-10 sm:px-10 bg-[#486681] gap-y-8 rounded-3xl sm:gap-x-5 flex-col sm:flex-row">
            <div className='text-center sm:text-left'>
              <div className='w-full'>
                <img className='h-16 mx-auto sm:mx-0' src={target} alt="" />
              </div>
              <div className='my-4 font-bold text-2xl text-white pl-2'>
                Our Mission
              </div>
              <div className='text-base text-gray-300 pl-2'>
        ...
        <div>
          ...
          <div className='mt-8 flex justify-center items-center gap-x-20 gap-y-12 mb-5 flex-wrap'>
      ...
      <div className="mt-24 lg:px-24 px-7 py-8  flex items-center" style={{
        minHeight: "350px",
        width: "100%",
        ...
        <div className='py-2 px-3 bg-[#6EC740] text-white rounded w-fit cursor-pointer hover:bg-[#6ea14b] shadow-lg'>
        Explore Careers
        </div>
        </div>
